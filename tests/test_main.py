...
def test_page_with_includes(t):
    ...
    resp = t.get('/foo.html')
    assert resp.status_code == HTTP_OK
    assert resp.data.decode() == 'foobar'
...
def test_do_not_include_non_template_files_in__index(t):
    ...
    resp = t.get('/_index.html')
    assert 'href="main.js"' not in resp.data.decode()
...
def test_setting_force_fragment_inclusion_in__index(c):
    ...
    resp = t.get('/_index.html')
    assert 'href="%s"' % name in resp.data.decode()
...
def test_setting_force_ignore_in__index(c):
    ...
    resp = t.get('/_index.html')
    assert not 'href="%s"' % name in resp.data.decode()
...
def test_setting_force_ignore_in__index_with_patterns(c):
    ...
    assert 'href="a.html"' in resp.data.decode()
    assert 'href="b.html"' in resp.data.decode()
    assert 'href="b/aa.html"' not in resp.data.decode()
    assert 'href="b/c.html"' in resp.data.decode()
    assert 'href="b/ab.html"' not in resp.data.decode()

    assert 'href="zoo.html"' not in resp.data.decode()
    assert 'href="foo.html"' not in resp.data.decode()
    assert 'href="b/loremipsum-oo.html"' not in resp.data.decode()
...
def test_setting_force_inclusion_in__index_with_patterns(c):
    ...
    assert 'href="aaa.html"' in resp.data.decode()
    assert 'href="aab.html"' in resp.data.decode()
    assert 'href="abc.html"' not in resp.data.decode()
    assert 'href="add.html"' not in resp.data.decode()

    assert 'href="zoo.html"' not in resp.data.decode()
    assert 'href="foo.html"' not in resp.data.decode()
    assert 'href="b/loremipsum-oo.html"' in resp.data.decode()
